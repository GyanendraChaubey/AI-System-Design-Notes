...
The infrastructure that finds relevant information before generation happens: embeddings, vector databases, indexing algorithms, and the hybrid search/reranking pipelines production retrieval actually runs.
