...
- **The handbook's [Deep Research Agent](../25-case-studies/07-deep-research-agent.md) case study** works through a from-scratch design for this product category end to end — query decomposition, parallel source gathering, report synthesis — as an applied instance of these patterns, illustrative rather than a claim about any specific shipped product's internals.
...
- Anthropic's published multi-agent research system and the handbook's own [Deep Research Agent](../25-case-studies/07-deep-research-agent.md) and [Multi-Agent Research System](../25-case-studies/16-multi-agent-research-system.md) case studies work through this exact orchestrator-worker shape at full implementation depth.
